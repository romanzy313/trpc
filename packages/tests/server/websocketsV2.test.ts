// NOTE: line 177 had to introduce any to the type. The tests still work though
...
import type { WSSHandlerOptions } from '@trpc/server/adapters/wsV2';
...
function factory(config?: {
  ...
  const opts = routerToServerAndClientNew(appRouter, {
    ...
    wssServer: {
      ...
      router: appRouter,
    } as any, // FIXME: any was added here
  });
